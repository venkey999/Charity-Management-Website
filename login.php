              ...
              <form role="form" method="post" action="loginCheck.php">
                  <div class="row">
                      ...
                      <label for="username"><span class="text-danger" style="margin-right:5px;">*</span>Username:</label>
                          <div class="input-group">
                              <input class="form-control" id="username" type="text" name="username1" placeholder="Username" required/>
                  ...
                  <div class="row">
                      <div class="form-group col-xs-10">
                        links that may be useful to you :-<br><br>
                          <a href="index.php">if you are admin click here..</a><br>
                          <a href="signup.php">New user? then click here..</a><br>
                          <a href="nologincharity.php">want to be private? no need of login click here..</a>
                      </div>
                  </div>
              </form>
          </div>
